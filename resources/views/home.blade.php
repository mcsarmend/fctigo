                                    ...
                                    <span id="_13.6" style=" font-family:Arial; font-size:13.6px; color:#000000">
                                        <span id="_13.6" style=" font-family:Arial; font-size:13.6px; color:#000000">
                                            Ciudad de M&#233;xico, M&#233;xico, a <a
                                                ...
                                                id="start-dateh" name="start-dateh"></a></span>
                                </div>
                            ...
                            buttons: [{
                                ...
                                },
                                {
                                    ...
                                    customize: function(doc) {
                                        ...
                                        doc.pageOrientation = 'landscape'; // Puedes usar 'portrait' o 'landscape'
                                        doc.pageMargins = [5, 10, 10, 10]; // Márgenes [izquierda, arriba, derecha, abajo]
                                    }
                                }
