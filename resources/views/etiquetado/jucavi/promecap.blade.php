                ...
                <div class="row section">
                    <div class="col-md-8 col-sm-6 mb-3">
                        <button class="btn btn-outline-primary w-100"
                            id="preetiquetadoPromecapJucavi">Preetiquetado Promecap</button>
                    </div>
                </div>
                <div class="row section">
                        ...
                        <form id="bajaPromecapJucavi">
                            <div class="input-group mb-3">
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" id="excelBajaJucavi" accept=".xlsx, .xls">
                                    <label class="custom-file-label-baja" for="excelBajaJucavi">Seleccionar archivo...</label>
                                </div>
        ...
        $('#preetiquetadoPromecapJucavi').click(function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    var fechaActual = getdateformatted(); // Crea un objeto Date con la fecha y hora actuales
